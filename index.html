         ...
         <!-- Login Form -->
            <form id="loginForm">
                <div class="mb-4">
                    ...
                    <input id="loginEmail" type="email" value="user@example.com" class="w-full mt-1 px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none invalid:border-red-500 invalid:focus:ring-red-500" required>
...
<div class="mb-6 relative">
                    ...
                    <div class="relative mt-1">
                        <input id="loginPassword" type="password" value="userpass" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none pr-12 invalid:border-red-500 invalid:focus:ring-red-500" required>
