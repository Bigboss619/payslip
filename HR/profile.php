        ...
        <main class="overflow-y-auto bg-slate-50 p-4 md:p-6">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="profile-card rounded-2xl border border-gray-100 bg-white p-6 text-center shadow-sm">
              ...
              <?php if ($photo && file_exists('../api/uploads/dp/' . $photo)): ?>
                <div class="profile-avatar mx-auto h-28 w-28 overflow-hidden rounded-2xl border border-gray-200 bg-gray-50 p-1">
                  <img src="../api/uploads/dp/<?= htmlspecialchars($photo) ?>" alt="Profile Picture" class="h-full w-full rounded-xl object-cover">
              ...
              <form id="profile-pic-form" method="post" action="../api/services/hrprofile.php" enctype="multipart/form-data" class="mt-6 space-y-2">
                ...
                <button type="submit" id="upload-btn" class="profile-btn ml-1 hidden rounded-xl bg-blue-600 px-6 py-2 font-medium text-white hover:bg-blue-700 cursor-pointer">Save Photo</button>
              </form>
            ...
            <div class="lg:col-span-2 space-y-6">
              ...
              <!-- PERSONAL INFO -->
              <form method="post" action="../api/services/hrprofile.php" class="profile-card rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
              ...
              <div class="profile-card rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
                ...
                <form method="post" action="../api/services/hrprofile.php" class="space-y-4">
