 <!-- Header -->
  ...
  <!-- Nav Section -->
   <?php include_once("../includes/nav.php"); ?>
    ...
    <!-- PAGE TITLE -->
    <div class="mb-6">
        <h1 class="text-2xl font-bold"><?php echo ($_SESSION['role'] === 'HR') ? 'All Payslips' : 'My Payslips'; ?></h1>
        <p class="text-gray-500 text-sm"><?php echo ($_SESSION['role'] === 'HR') ? 'View and download all employee salary history' : 'View your salary history'; ?></p>
    </div>
