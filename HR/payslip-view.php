...
<body>
    <style>
      @media print {
        ...
        .shadow-2xl, .rounded-3xl { box-shadow: none !important; border-radius: 0 !important; }
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <nav class="p-4 space-y-2 overflow-hidden">
          ...
          <a href="dashboard.php" class="sidebar-link block px-4 py-3 rounded-lg bg-blue-100 text-blue-600 font-medium group relative">
          ...
          <a href="payslip.php" class="sidebar-link block px-4 py-3 rounded-lg hover:bg-gray-100 group relative">
            <svg class="w-5 h-5 flex-shrink-0 inline-block mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <a href="profile.php" class="sidebar-link block px-4 py-3 rounded-lg hover:bg-gray-100 group relative">
            <svg class="w-5 h-5 flex-shrink-0 inline-block mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
            </svg>
            <span>Profile</span>
          ...
          <a href="../index.php" class="sidebar-link block px-4 py-3 rounded-lg hover:bg-gray-100 text-red-500 group relative">
            <svg class="w-5 h-5 flex-shrink-0 inline-block mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
